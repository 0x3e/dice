...
#
# * build - compiles your coffee directory to your lib directory
# * watch - watches any changes in your coffee directory and automatically compiles to the lib directory
...
# **and** defaulted options to compile coffee to lib
...
unlinkIfCoffeeFile = (file) ->
  if file.match /\.coffee$/
    fs.unlink file.replace('coffee','lib').replace(/\.coffee$/, '.js'), ->
    true
  else false
